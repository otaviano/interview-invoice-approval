...
public sealed class DirectorApprovalHandler : ApprovalHandler
{
    private const decimal Threshold = 1_000m;
    ...
    public override void Handle(ApprovalContext context)
    {
        ...
        if (context.IsPreferredVendor && !context.PreferredVendorSkipApplied)
            ...
            context.Approvers.Add(ApproverLevel.Director.ToString());
